...
>
> Актуальная версия того, что лежало здесь: [`mcp/yandex-maps-mcp/`](https://github.com/theYahia/YaAll/tree/main/mcp/yandex-maps-mcp)
>
> Пакет в npm прежний — [`@theyahia/yandex-maps-mcp`](https://www.npmjs.com/package/@theyahia/yandex-maps-mcp), ставится и работает как раньше.
...
> The current version of this package now lives at [`mcp/yandex-maps-mcp/`](https://github.com/theYahia/YaAll/tree/main/mcp/yandex-maps-mcp).
> The npm package [`@theyahia/yandex-maps-mcp`](https://www.npmjs.com/package/@theyahia/yandex-maps-mcp) is unchanged.
